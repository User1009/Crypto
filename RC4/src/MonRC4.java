...
public class MonRC4
{
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileInputStream fis = new FileInputStream("/amuhome/l16013609/Documents/HMAC/resume/MD5_en_Java/butokuden.jpg");;
        FileOutputStream fos = new FileOutputStream("/amuhome/l16013609/Documents/HMAC/resume/MD5_en_Java/confidentiel.jpg");

        //Chiffre l'image butokuden dans confidentiel
        while(fis.available()>0) {
            int pictureByte = fis.read();
            int key = production();
            fos.write(pictureByte ^ key);

        }

        //Chiffre confidentiel
        initialisation();
        FileInputStream fis_2 = new FileInputStream("/amuhome/l16013609/Documents/HMAC/resume/MD5_en_Java/confidentiel.jpg");
        FileOutputStream fos_2 = new FileOutputStream("/amuhome/l16013609/Documents/HMAC/resume/MD5_en_Java/confidentiel_2.jpg");

        while(fis_2.available()>0) {

            int pictureByte = fis_2.read();
            int key = production();
            fos_2.write(pictureByte ^ key);
